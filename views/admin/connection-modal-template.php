						...
						<tr>
							...
							<# if ( data.isUserConnected ) { #>
								...
								<td>
									...
									<# } #>
										<a class="button" href="<?php echo wp_nonce_url( Jetpack::admin_url( 'action=unlink' ), 'jetpack-unlink' ); ?>"><?php esc_html_e( ' Disconnect', 'jetpack' ); ?></a>
								</td>
							<# } else { #>
								<td>&nbsp;</td>
